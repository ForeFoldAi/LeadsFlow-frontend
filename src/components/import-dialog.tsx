        ...
        complete: async (results) => {
          ...
          try {
            ...
            const transformedLeads = leads
              ...
              .filter(lead => lead !== null) as CreateLeadDto[]; // Filter out any null leads
            ...
            try {
              ...
              if (importResponse.successful > 0) {
                toast({
                  ...
                  description: `${importResponse.successful} leads imported successfully from ${leads.length} rows in CSV.`,
                });
